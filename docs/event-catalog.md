...
| Memory | `MemoryCandidateCreated`, `MemoryPromoted`, `MemoryRejected`, `MemorySuperseded`, `MemoryExpired`, `MemoryRevisionMaterialized` |
| Sleep and review | `SleepRunStarted`, `IntegrationCandidateCreated`, `SleepRunCompleted`, `SleepRunInterrupted`, `SleepRunFailed`, `IntegrationCandidateVerified`, `IntegrationCandidateRejected`, `IntegrationCandidateMaterialized` |
